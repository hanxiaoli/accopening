...
// @XmlRootElement
// @NamedQueries({
// @NamedQuery(name = "RegulationMaster.findAll", query = "SELECT r FROM
// RegulationMaster r")
// , @NamedQuery(name = "RegulationMaster.findByRegulationId", query = "SELECT r
// FROM RegulationMaster r WHERE r.regulationMasterPK.regulationId =
// :regulationId")
// , @NamedQuery(name = "RegulationMaster.findByRegulationName", query = "SELECT
// r FROM RegulationMaster r WHERE r.regulationName = :regulationName")
// , @NamedQuery(name = "RegulationMaster.findByItemLevel1No", query = "SELECT r
// FROM RegulationMaster r WHERE r.regulationMasterPK.itemLevel1No =
// :itemLevel1No")
// , @NamedQuery(name = "RegulationMaster.findByItemLevel1Label", query =
// "SELECT r FROM RegulationMaster r WHERE r.itemLevel1Label =
// :itemLevel1Label")
// , @NamedQuery(name = "RegulationMaster.findByItemLevel2No", query = "SELECT r
// FROM RegulationMaster r WHERE r.regulationMasterPK.itemLevel2No =
// :itemLevel2No")
// , @NamedQuery(name = "RegulationMaster.findByItemLevel2Label", query =
// "SELECT r FROM RegulationMaster r WHERE r.itemLevel2Label =
// :itemLevel2Label")
// , @NamedQuery(name = "RegulationMaster.findByItemLevel3No", query = "SELECT r
// FROM RegulationMaster r WHERE r.regulationMasterPK.itemLevel3No =
// :itemLevel3No")
// , @NamedQuery(name = "RegulationMaster.findByItemLevel3Label", query =
// "SELECT r FROM RegulationMaster r WHERE r.itemLevel3Label =
// :itemLevel3Label")
// , @NamedQuery(name = "RegulationMaster.findByItemLevel4No", query = "SELECT r
// FROM RegulationMaster r WHERE r.regulationMasterPK.itemLevel4No =
// :itemLevel4No")
// , @NamedQuery(name = "RegulationMaster.findByItemLevel4Label", query =
// "SELECT r FROM RegulationMaster r WHERE r.itemLevel4Label =
// :itemLevel4Label")
// , @NamedQuery(name = "RegulationMaster.findByItemLevel5No", query = "SELECT r
// FROM RegulationMaster r WHERE r.regulationMasterPK.itemLevel5No =
// :itemLevel5No")
// , @NamedQuery(name = "RegulationMaster.findByItem5Label", query = "SELECT r
// FROM RegulationMaster r WHERE r.item5Label = :item5Label")
// , @NamedQuery(name = "RegulationMaster.findByItemLevel6No", query = "SELECT r
// FROM RegulationMaster r WHERE r.regulationMasterPK.itemLevel6No =
// :itemLevel6No")
// , @NamedQuery(name = "RegulationMaster.findByItemLevel6Label", query =
// "SELECT r FROM RegulationMaster r WHERE r.itemLevel6Label =
// :itemLevel6Label")
// , @NamedQuery(name = "RegulationMaster.findByRegulationCreateDate", query =
// "SELECT r FROM RegulationMaster r WHERE r.regulationCreateDate =
// :regulationCreateDate")
// , @NamedQuery(name = "RegulationMaster.findByRegulationUpdateDate", query =
// "SELECT r FROM RegulationMaster r WHERE r.regulationUpdateDate =
// :regulationUpdateDate")
// , @NamedQuery(name = "RegulationMaster.findByCreateTime", query = "SELECT r
// FROM RegulationMaster r WHERE r.createTime = :createTime")
// , @NamedQuery(name = "RegulationMaster.findByUpdateTime", query = "SELECT r
// FROM RegulationMaster r WHERE r.updateTime = :updateTime")})
public class RegulationMaster implements Serializable {
	...
	public RegulationMaster(String regulationId, int itemLevel1No, int itemLevel2No, int itemLevel3No, int itemLevel4No,
			int itemLevel5No, int itemLevel6No) {
		this.regulationMasterPK = new RegulationMasterPK(regulationId, itemLevel1No, itemLevel2No, itemLevel3No,
				itemLevel4No, itemLevel5No, itemLevel6No);
	}
	...
	public boolean equals(Object object) {
		...
		if ((this.regulationMasterPK == null && other.regulationMasterPK != null)
				|| (this.regulationMasterPK != null && !this.regulationMasterPK.equals(other.regulationMasterPK))) {
			return false;
		}
		return true;
	}
