...
public class RegulationMasterPK implements Serializable {
	...
	public RegulationMasterPK(String regulationId, int itemLevel1No, int itemLevel2No, int itemLevel3No,
			int itemLevel4No, int itemLevel5No, int itemLevel6No) {
	...
	public String toString() {
		return "jp.co.basenet.accopening.entity.RegulationMasterPK[ regulationId=" + regulationId + ", itemLevel1No="
				+ itemLevel1No + ", itemLevel2No=" + itemLevel2No + ", itemLevel3No=" + itemLevel3No + ", itemLevel4No="
				+ itemLevel4No + ", itemLevel5No=" + itemLevel5No + ", itemLevel6No=" + itemLevel6No + " ]";
	}
